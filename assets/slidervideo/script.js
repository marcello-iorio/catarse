            ...
            $(event.target).outerFind('[data-bg-video-slide]').each(function() {
                ...
                if (playerName === 'youtube') {
                    getYTPreviewUrlWithBestQuality(videoId).done(function(url) {
                        //Fiz essa condição para mudar o segundo slide que é da Delos consultoria
                        if(videoId == "xolniTIwizU"){
                            $preview.css('background-image', 'url("custom/images/delos_consultoria.png")').show();
                        }else{
